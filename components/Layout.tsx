...
const Navbar = () => {
  ...
  return (
    <motion.header 
      ...
      className="sticky top-0 z-50 w-full border-b border-slate-200 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60 dark:border-slate-800 dark:bg-slate-950/80 dark:supports-[backdrop-filter]:bg-slate-950/60"
    >
        ...
        <div className="flex items-center gap-6">
          ...
          >
            <motion.div 
              ...
              className="w-8 h-8 rounded-lg bg-primary-600 flex items-center justify-center text-white"
            >
              <Command size={18} />
            </motion.div>
            ...
            <AnimatePresence>
              {searchResults.length > 0 && (
                <motion.div 
                  ...
                  exit={{ opacity: 0, y: 10 }}
                  className="absolute top-full mt-2 left-0 w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg shadow-lg overflow-hidden py-1"
                >
